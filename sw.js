const CACHE_NAME = 'frannies-good-girl-v15';
const APP_SHELL = ['./','./index.html','./styles.css?v=15','./app.js?v=15','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
