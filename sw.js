const CACHE_NAME = 'frannies-good-girl-v17';
const APP_SHELL = ['./','./index.html','./styles.css?v=17','./app.js?v=17','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
