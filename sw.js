const CACHE_NAME = 'frannies-good-girl-v9';
const APP_SHELL = ['./','./index.html','./styles.css?v=9','./app.js?v=9','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
