const CACHE_NAME = 'frannies-good-girl-v18';
const APP_SHELL = ['./','./index.html','./styles.css?v=18','./app.js?v=18','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
