const CACHE_NAME = 'frannies-good-girl-v12';
const APP_SHELL = ['./','./index.html','./styles.css?v=12','./app.js?v=12','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
