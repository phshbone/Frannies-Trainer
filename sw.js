const CACHE_NAME = 'frannies-good-girl-v4';
const APP_SHELL = ['./','./index.html','./styles.css','./app.js?v=4','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
