const CACHE_NAME = 'frannies-good-girl-v5';
const APP_SHELL = ['./','./index.html','./styles.css','./app.js?v=5','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
