const CACHE_NAME = 'frannies-good-girl-v19';
const APP_SHELL = ['./','./index.html','./styles.css?v=19','./app.js?v=19','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
