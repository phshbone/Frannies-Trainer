const CACHE_NAME = 'frannies-good-girl-v14';
const APP_SHELL = ['./','./index.html','./styles.css?v=14','./app.js?v=14','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
